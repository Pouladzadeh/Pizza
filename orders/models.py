...
class Pasta(models.Model):
    ...
    price = models.DecimalField(
        help_text="Price in U$S", max_digits=4, decimal_places=2)

    def __str__(self):  # str defines what the objects should look like when it it's printed out to a screen
...
class DinnerPlatter(models.Model):
    ...
    price = models.DecimalField(
        help_text="Price in U$S", max_digits=5, decimal_places=2)
